...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /home/krti2024_pi/src/RPLidar/hector_slam/hector_imu_tools)
  set(hector_imu_tools_DEVEL_PREFIX /home/krti2024_pi/devel/.private/hector_imu_tools)
  ...
  set(hector_imu_tools_INSTALL_PREFIX /home/krti2024_pi/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/krti2024_pi/src/RPLidar/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/krti2024_pi/devel/.private/hector_imu_tools/lib;/home/krti2024_pi/devel/lib;/opt/ros/noetic/lib)
